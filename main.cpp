...
int main(int argc, char **argv)
{
    ...
    ImageRGB8u sample(widthImage, heightImage);
    ...
    HdrCompute::handleRGB("linear", sample, pixels, imagesMatricesColors, exposure,0,255);
    saveJPG(grayLinear,"../output/sample.jpg");
